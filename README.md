...
# The taxizedb NCBI database should be updated regularly to keep up to date with the GenBank nt database (as much as possible - there seems to be some
# lag in the taxizedb online database) 
...
# Add the scripts dada2_demultiplexing_v2.sh, dada2_sickle.r, dada2_match.r, dada2_remove_errors.r, dada2_sum_AS_SS.r, dada2_sum_libraries.r and my_taxonomy_extended.r to the scripts folder. 
...
# Marie Lund at Microbiology recommends to do dada2 cleaning before demultiplexing!
